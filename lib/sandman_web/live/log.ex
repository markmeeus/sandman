defmodule SandmanWeb.LiveView.Log do
  ...
  def render(assigns) do
    ~H"""
      ...
      <div id="sandman-log" class="text-xs text-neutral-200 overflow-contain overflow-scroll flex-1 border-l border-r border-b border-neutral-600 rounded-b bg-neutral-800">
